...
const config = {
  ...
  CLUSTER_API: 'https://pentacle.genesysgo.net',
  // CLUSTER_API: 'https://api.mainnet-beta.solana.com',

  siteUrl: '',

  // Bot Owner
  ownerId: "950329932721049620",

  // DB Connection Url from mongodb
  dbConnection: "mongodb+srv://root:password1!@cluster0.cagnj.mongodb.net/daoverification?retryWrites=true&w=majority",
  // dbConnection: "mongodb://localhost/daoverification",
  ...
  intents: [
    ...
    Intents.FLAGS.GUILD_PRESENCES, //Privileged intent provided is not enabled or whitelisted.
  ...
  permLevels: [
    ...
    // Updated to utilize the Teams type from the Application, pulls a list of "Owners" from it.
    {
      ...
      check: (message) => {
        ...
        return owner.id === "950329932721049620";
      }
    }
  ],
